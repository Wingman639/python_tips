...
def merge_a_file(source_path, distination_path):
	if os.path.exists(distination_path) and BACKUP_ORG_FILE: 
		if FULL_INFO_MODE: print 'rename: %s-ORG' % distination_path
		os.rename(distination_path, distination_path + '-ORG')
